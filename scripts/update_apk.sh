...
git config --global user.email "noreply+travis+robofeel@robotutor.org"
...
git clone --quiet --branch=apk https://robotutor:$GH_TOKEN@github.com/RoboTutorLLC/RoboFeel apk > /dev/null
cd apk
